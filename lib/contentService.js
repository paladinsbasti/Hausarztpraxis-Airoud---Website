...
const defaultContent = {
  ...
  doctorImage: 'https://via.placeholder.com/400x500/4a90a4/ffffff?text=Hausarztpraxis+Airoud'
  },
  services: { title: 'Unsere Leistungen', subtitle: 'Umfassende Versorgung', items: [] },
  about: {
    title: 'Über uns', doctorName: 'Abdullah Airoud', qualification: 'Facharzt für Innere Medizin-Notfallmedizin',
    welcome: 'Herzlich willkommen.', languagesTitle: 'Sprachkenntnisse:', languagesDesc: 'Deutsch, Englisch, Arabisch, Italienisch.',
    teamTitle: 'Unser Team', teamDesc: 'Engagiert für Ihre Gesundheit.'
  },
  contact: {
    title: 'Kontakt', subtitle: 'Wir sind für Sie da', address: 'Eschenstr. 138<br>42283 Wuppertal',
    phone: '0202 25 350 880', email: 'info@hausarztpraxis-airoud.de', hoursTitle: 'Sprechzeiten',
    hours: []
  }
};
